...
const UCPL_TOOLS = [
  {
    label: "search:web",
    detail: "Web search",
    doc: "Search the web for information with optional filters",
  },
  {
    label: "search:code",
    detail: "Code search",
    doc: "Search code patterns in files",
  },
  {
    label: "think:deep",
    detail: "Deep reasoning",
    doc: "Use deep reasoning tools for complex analysis",
  },
  {
    label: "fetch:url",
    detail: "Fetch URL",
    doc: "Retrieve content from a URL",
  },
  {
    label: "read:files",
    detail: "Read files",
    doc: "Read file contents with pattern matching",
  },
  {
    label: "write:files",
    detail: "Write files",
    doc: "Write content to files",
  },
  {
    label: "execute:shell",
    detail: "Execute shell",
    doc: "Run shell commands with timeout support",
  },
  {
    label: "memory:save",
    detail: "Save to memory",
    doc: "Persist data to memory with key-value storage",
  },
  {
    label: "memory:load",
    detail: "Load from memory",
    doc: "Retrieve saved data from memory",
  },
] as const;
...
function getDirectiveCompletions(): vscode.CompletionItem[] {
  const directives = [
    ...
    {
      label: "scope",
      detail: "Limit work to specific area",
      kind: vscode.CompletionItemKind.Keyword,
    },
    {
      label: "out",
    ...
    {
      label: "def",
      detail: "Define reusable macro",
      kind: vscode.CompletionItemKind.Keyword,
    },
    {
      label: "workflow",
      detail: "Multi-step workflow",
      kind: vscode.CompletionItemKind.Keyword,
    },
    {
      label: "chain",
    ...
    {
      label: "until",
      detail: "Loop termination condition",
      kind: vscode.CompletionItemKind.Keyword,
    },
    {
      label: "use",
      detail: "Execute macro",
      kind: vscode.CompletionItemKind.Keyword,
    },
  ];
